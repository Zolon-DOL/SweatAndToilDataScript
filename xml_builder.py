...
#wb = load_workbook('master_data_updated_9.10.19.xlsx')
# wb = load_workbook('master_data-20200722.xlsx')
...
multi_territory_countries = ['Tanzania', 'Pakistan', 'Iraq', 'Bosnia and Herzegovina']
